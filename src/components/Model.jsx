...
const Model = () => {
    ...
    //rotation
    const [smallRotatio, setSmallRotation]=useState(0)
    const [largeRotatio, setLargeRotation]=useState(0)

    useGSAP(()=>{
        gsap.to('#heading', {
            y:0, 
            opacity:1,
            scrollTrigger:{trigger:"#model"},
        })
    },[])
    return (
        <section className="common-padding">
            <div  id='model' className=" screen-max-width">

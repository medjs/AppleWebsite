...
const VideoCarousal = () => {
    ...
    useEffect(() => {
        ...
        //if we have a span of a video id then we can animate it
        if (span[videoId]) {
    ...
    return (
        <>
            ...
            <div className="relative flex-center mt-10">
                ...
                <button className=" control-btn"><img src={isLastVideo ? replayImg : !isPlaying ? playImg : pauseImg} alt={isLastVideo ? 'replay' : !isPlaying ? 'play' : 'pause'}
